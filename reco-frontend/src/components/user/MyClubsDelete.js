...
export const MyClubsDelete = () => {
  ...
  return (
    <div className="main">
      ...
      <h3 id="delete-text">
        Are you sure you want to remove this club from your list?
      </h3>
      ...
      <div className="delete-reco">
        ...
        <Button variant="primary" onClick={clickDeleteHandler}>
          Delete
        </Button>
        <h1> </h1>
        <Button variant="primary" onClick={() => history.push(`/my-club`)}>
          Cancel
        </Button>
      </div>
    </div>
